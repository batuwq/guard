...
module.exports = {
    ...
    execute: async (client, message, args, anan, author, channel, guild) => {
        ...
        let embed = new MessageEmbed().setColor('#2F3136').setTitle(message.member.displayName, message.author.avatarURL({ dynamic: true })).setColor('RED').setFooter("BoranGkdn was here!")
